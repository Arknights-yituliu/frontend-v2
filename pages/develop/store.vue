    ...
    <div id="store">
      ...
      <div class="op_title">
        <div class="op_title_text">
          ...
          <div :class="opETextTheme">Store Rank</div>
        </div>
      ...
      <div class="store_content" id="store_0" :style="storeVisiable[0]">
        ...
        <div
          v-for="(m_data, index) in storeList[0]"
          class="store_unit"
          :key="index"
        >
      ...
      <div class="store_content" id="store_1" :style="storeVisiable[1]">
        ...
        <div
          v-for="(m_data, index) in storeList[3]"
          class="store_unit"
          :key="index"
        >
          <div :class="getSpriteImg(m_data.itemId, 1)"></div>
      ...
      <div class="store_content" id="store_2" :style="storeVisiable[2]">
        ...
        <div
          v-for="(m_data, index) in storeList[1]"
          class="store_unit"
          :key="index"
        >
          <div :class="getSpriteImg(m_data.itemId, 1)"></div>
      ...
      <div class="store_content" id="store_3" :style="storeVisiable[3]">
        ...
        <div
          v-for="(m_data, index) in storeList[2]"
          class="store_unit"
          :key="index"
        >
          <div :class="getSpriteImg(m_data.itemId, 1)"></div>
      ...
      <div class="store_content" id="store_4" :style="storeVisiable[4]">
        ...
        <div
          v-for="(m_data, index) in storeList[4]"
          class="store_unit"
          :key="index"
        >
          <div :class="getSpriteImg(m_data.itemId, 1)"></div>
    ...
    <div id="actStore">
      ...
      <div class="op_title">
        <div class="op_title_text">
          ...
          <div :class="opETextTheme">Activity</div>
        </div>
      </div>
      <!-- 标题区域end -->
      <!-- 内容区域 -->
          ...
          <div class="act_content">
            ...
            >
              ...
              <div class="act_card_img">
                <img
                  class="level_img"
                  :src="getImgUrl(singleItem.itemName, 1)"
            ...
            >
              ...
              <div class="act_card_img">
                <img
                  ...
                  :alt="singleItem.itemName"
                />
                <!-- <div :class="getImg(singleItem.itemId,2)" ></div> -->
              </div>
              <div class="act_card_table">
                <table class="act_table">
                  <tbody>
...
export default {
  ...
  methods: {
    ...
    getImgUrl(img, source) {
      ...
      if (source > 4.1) return "/img/materials-bak/道具_" + img + ".png";
      ...
      else if (source > 0.1) return "/img/materials-bak/" + img + ".png";
      else
        return (
