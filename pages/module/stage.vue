      ...
      <div class="op_content" id="stage_t3_content">
        ...
        >
          ...
          <div
            ...
            :class="getSpriteImg(materialRankT3[0].itemId, 'type')"
          ></div>
    ...
    <div id="popup_content">
      ...
      <div class="popup_card" id="popup_card">
        <div class="popup_header">
          <div
            :class="getSpriteImg(itemId, 'title')"
            ...
            <tbody style="font-size: 20px; vertical-align: baseline">
              ...
              >
                ...
                <td class="popup_table_c5" style="width: 95px">
                  {{ getEfficiency(stage.stageEfficiency) }}%
                </td>
                <td class="popup_table_c6" style="width: 95px">
                  {{ getEfficiency(stage.orundumPerApEfficiency) }}%
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <div id="popup_card_history">
        ...
        >
          ...
          <div class="history_actStages">
            ...
            >
              <div
                :class="getSpriteImg(stage.itemId, 'title')"
                style="display: inline-block"
              ></div>
...
export default {
  ...
  methods: {
    ...
    getStageResultDateT3() {
      stageApi
        .findStageDateByTypeOrderByEfficiencyDesc(this.stageVersion)
        .then((response) => {
          this.stageRankT3 = [];
    ...
    getStageResultDateClosed() {
      stageApi
        .findClosedActivStageByStageId(this.stageVersion)
        .then((response) => {
