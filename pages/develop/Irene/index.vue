  ...
  <div>
    <table>
      <tbody>
        ...
        <tr>
          <td>
            <el-select v-model="char_profession" placeholder="请选择" @change="IreneCal()">
              <el-option v-for="item in char_professionList" :key="item" :label="item" :value="item"> </el-option>
            </el-select>
          </td>
          <td>
        ...
        <tr>
          <td>专精一</td>
          <td colspan="3">在训练{{ doubleProf1_time }}后，剩余{{ doubleProf1_remaining_time }}时换成艾丽妮</td>
        </tr>
        <tr>
          <td>专精二</td>
          <td colspan="3">在训练{{ doubleProf2_time }}后，剩余{{ doubleProf2_remaining_time }}时换成艾丽妮</td>
        </tr>
      </tbody>
    </table>
  </div>
  ...
  methods: {
    IreneCal() {
      ...
      if ("狙击近卫" === this.char_profession) {
        ...
        this.doubleProf1_time = doubleProf1_front_hh + "小时" + doubleProf1_front_mm + "分钟";

        var doubleProf1_remaining_ms = (doubleProf1_ms - doubleProf1_front_ms * front1_spd) / front1_spd; //前置干员撤出前剩余时长
        ...
        this.doubleProf1_remaining_time =
          this.addZero(doubleProf1_remaining_hh) + ":" + this.addZero(doubleProf1_remaining_mm) + ":00";
        ...
        this.doubleProf2_time = doubleProf2_front_hh + "小时" + doubleProf2_front_mm + "分钟";

        var doubleProf2_remaining_ms = (doubleProf1_ms - doubleProf2_front_ms * front2_spd) / front2_spd;
        ...
        this.doubleProf2_remaining_time =
          this.addZero(doubleProf2_remaining_hh) + ":" + this.addZero(doubleProf2_remaining_mm) + ":00";
