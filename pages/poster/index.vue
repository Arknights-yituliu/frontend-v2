    ...
    <div class="poster_main">
      <div class="poster_title">
        ...
        <div class="poster_title_H1">
          <a class="poster_title_H1_up">BATE舟报</a><a class="poster_title_H1_down">BATE周报</a>
        </div>
        <div class="poster_title_H2">
          <a class="poster_title_H2_time">2023-01-22</a><a class="poster_title_H2_version">#4</a>
        </div>
      </div>
